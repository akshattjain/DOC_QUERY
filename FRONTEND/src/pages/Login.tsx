...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-96 h-96 bg-fuchsia-500/20 rounded-full blur-[100px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md bg-white/70 backdrop-blur-xl border border-white p-8 rounded-2xl shadow-xl z-10 relative">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">Sign in to continue your research</p>
        </div>
